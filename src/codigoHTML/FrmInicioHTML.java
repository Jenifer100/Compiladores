           ...
           try {
            ...
            switch (token) {
                ...
                case Comillas:
                    ...
                    break;
                case Html:
                    resultado += "  <Reservada html>\t" + lexer.lexeme + "\n";
                    break;
                case P:
                    resultado += "  <Reservada P>\t" + lexer.lexeme + "\n";
                    break;
                case Body:
                    resultado += "  <Reservada Body>\t" + lexer.lexeme + "\n";
                    break;
                case Title:
                    resultado += "  <Reservada Tible>\t" + lexer.lexeme + "\n";
                    break;
                case Big:
                    resultado += "  <Reservada Big>\t" + lexer.lexeme + "\n";
                    break;
                     case Head:
                    resultado += "  <Reservada head>\t" + lexer.lexeme + "\n";
                    break;
